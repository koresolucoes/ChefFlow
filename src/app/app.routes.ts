...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { 
        path: 'receitas', 
        loadComponent: () => import('./pages/receitas').then(m => m.ReceitasComponent) 
      },
      { 
        path: 'desperdicio', 
        loadComponent: () => import('./pages/desperdicio').then(m => m.DesperdicioComponent) 
      },
      { 
        path: 'equipe', 
      ...
      { 
        path: 'servico', 
        loadComponent: () => import('./pages/servico').then(m => m.ServicoComponent) 
      },
      { 
        path: 'estoque', 
      ...
      {
        path: 'requisicoes',
        loadComponent: () => import('./pages/requisicoes').then(m => m.RequisicoesComponent)
      },
      {
        path: 'contagem',
